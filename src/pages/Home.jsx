...
const Home = () => {
  return (
    <Box sx={{ display: "inline-block", width: "100%" }}>
      ...
      <Container>
        <Box>Welcome to the Home Page</Box>
        <Box>
          ...
          with 'Lorem ipsum dolor sit amet...' Where does it come from? Contrary
          ...
          amet...' Where does it come from? Contrary to popular belief, Lorem
